...
//        он должен выбрасывать исключение ArithmeticException. Не забудьте написать тесты для проверки
//        этого поведения.
//
...
//        продуктов и класс Shop для написания методов сортировки и тестов.
        ...
        // System.out.println(sum(2_147_483_647, 1));
         System.out.println(sum(2_147_483_644, 1));
    ...
    public static int sum(int a, int b) {
        assert ((long)a + (long) b) <  Integer.MAX_VALUE: "Out of range!";
        return  a +  b;
    }
    ...
    public static void checkingHero() {
        ...
        assertThat(emmett.getBag()).isNotEmpty().hasSize(3).
                contains("Bow", "Axe", "Gold");
        assert emmett.isHuman()==true: "type should be Human";
